...
% TODO: finish this section (should be relatively easy)
...
% How the pop-up generates the summary and user interface
...
% function that allows the content script to send messages to the pop-up

\subsubsection{Non-required features}

% TODO: maybe talk about extra features
